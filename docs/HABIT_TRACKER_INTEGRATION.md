...
> [!NOTE]
> The **Visual Activity Heatmap** (Section 2, `Repetitions`) was implemented in Phase 37.
> The **Internal Habit Tracking System** (CRUD UI, schema, TDD coverage, and mobile sync) was implemented in Phase 38.
