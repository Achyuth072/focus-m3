...
- [x] **Split View (Master-Detail)**: A 3-pane layout for power users (Sidebar | Task List | Selected Task Details) to reduce context switching.
...
- [x] **Event Overflow**: Add "+X more" button with popover for calendar days with many events.
- [x] **Visual Activity Heatmap**: GitHub-style consistency chart showing daily focus density. (See [HABIT_TRACKER_INTEGRATION.md](./HABIT_TRACKER_INTEGRATION.md)).
...
- [x] Phase 35: Timer Stability & Simplification (Revert Pending Toast, Reconcile Logic Hardening)
- [x] Phase 36: Event Overflow Popover (Interactive calendar event previews, Zen-Modernist aesthetics)
- [x] Phase 37: Visual Activity Heatmap (GitHub-style consistency chart, O(N) performance, TDD)
- [x] Phase 38: Habit Mastery & CRUD UI (Schema update, Create/Edit views, TDD coverage, iconography)
- [x] Phase 39: Calendar Precision & Kanban Evolution (Real-time indicator, Auto-scroll, Hybrid Stack columns)
- [ ] Phase 40: Google Calendar 2-Way Sync (Bi-directional integration, Conflict resolution)
