    ...
    <div className="space-y-6 py-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium" htmlFor="focus-duration-input">Focus Duration</Label>
          <div className="flex items-center gap-2">
            <Input
              ...
              aria-describedby={errors.focusDuration ? "focus-duration-error" : undefined}
            />
        ...
        <Slider
          value={[focusDuration]}
          onValueChange={([value]) => setValue('focusDuration', value, { shouldValidate: true })}
          min={1}
          max={120}
          step={1}
          className="w-full"
        ...
        {errors.focusDuration && (
          <p id="focus-duration-error" className="text-xs text-destructive font-medium">{errors.focusDuration.message}</p>
        )}
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium" htmlFor="short-break-input">Short Break</Label>
          <div className="flex items-center gap-2">
            <Input
              ...
              className={cn(
                "w-16 h-8 text-sm bg-secondary/30 border-transparent hover:bg-secondary/50 text-center rounded-md",
                errors.shortBreakDuration && "border-destructive ring-destructive"
              )}
              aria-invalid={!!errors.shortBreakDuration}
              aria-describedby={errors.shortBreakDuration ? "short-break-error" : undefined}
            />
            <span className="text-sm text-muted-foreground">min</span>
          </div>
        </div>
        <Slider
          value={[shortBreak]}
          onValueChange={([value]) => setValue('shortBreakDuration', value, { shouldValidate: true })}
          min={1}
          max={30}
          step={1}
          className="w-full"
        ...
        {errors.shortBreakDuration && (
          <p id="short-break-error" className="text-xs text-destructive font-medium">{errors.shortBreakDuration.message}</p>
        )}
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium" htmlFor="long-break-input">Long Break</Label>
          <div className="flex items-center gap-2">
            <Input
              id="long-break-input"
              type="number"
              ...
              className={cn(
                "w-16 h-8 text-sm bg-secondary/30 border-transparent hover:bg-secondary/50 text-center rounded-md",
                errors.longBreakDuration && "border-destructive ring-destructive"
              )}
              aria-invalid={!!errors.longBreakDuration}
              aria-describedby={errors.longBreakDuration ? "long-break-error" : undefined}
            />
            <span className="text-sm text-muted-foreground">min</span>
          </div>
        </div>
        <Slider
          value={[longBreak]}
          onValueChange={([value]) => setValue('longBreakDuration', value, { shouldValidate: true })}
          min={5}
          max={60}
          step={1}
          className="w-full"
        ...
        {errors.longBreakDuration && (
          <p id="long-break-error" className="text-xs text-destructive font-medium">{errors.longBreakDuration.message}</p>
        )}
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium" htmlFor="sessions-input">Sessions Until Long Break</Label>
          <Input
            id="sessions-input"
            type="number"
            ...
            className={cn(
              "w-16 h-8 text-sm bg-secondary/30 border-transparent hover:bg-secondary/50 text-center rounded-md",
              errors.sessionsBeforeLongBreak && "border-destructive ring-destructive"
            )}
            aria-invalid={!!errors.sessionsBeforeLongBreak}
            aria-describedby={errors.sessionsBeforeLongBreak ? "sessions-error" : undefined}
          />
        </div>
        <Slider
          value={[sessions]}
          onValueChange={([value]) => setValue('sessionsBeforeLongBreak', value, { shouldValidate: true })}
          min={2}
          max={10}
          step={1}
          className="w-full"
        ...
        {errors.sessionsBeforeLongBreak && (
          <p id="sessions-error" className="text-xs text-destructive font-medium">{errors.sessionsBeforeLongBreak.message}</p>
        )}
      </div>
      ...
      <div className="space-y-4 pt-2 border-t">
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <Label className="text-sm font-medium" htmlFor="auto-start-break-switch">Auto-start Breaks</Label>
          ...
          <Switch
            ...
            onCheckedChange={(checked) => setValue('autoStartBreak', checked, { shouldValidate: true })}
          />
        </div>
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <Label className="text-sm font-medium" htmlFor="auto-start-focus-switch">Auto-start Focus</Label>
            <p className="text-xs text-muted-foreground">Automatically start focus timer after break</p>
          </div>
          <Switch
            id="auto-start-focus-switch"
            checked={autoStartFocus}
            onCheckedChange={(checked) => setValue('autoStartFocus', checked, { shouldValidate: true })}
          />
        </div>
      </div>
    </div>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span id="settings-desc" className="sr-only">Form to update timer durations and transitions</span>
            </DialogDescription>
          </DialogHeader>
    ...
    <Drawer open={open} onOpenChange={setOpen} repositionInputs={false}>
      ...
      <DrawerContent className="max-h-[92dvh] flex flex-col">
        ...
        <DrawerFooter className="pt-2 shrink-0 pb-[calc(1rem+env(safe-area-inset-bottom))]">
          <Button onClick={handleSubmit(onFormSubmit)} disabled={!isValid}>Save Changes</Button>
          <DrawerClose asChild>
