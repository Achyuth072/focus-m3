...
const KanbanColumn = memo(function KanbanColumn({
  ...
  return (
    <div className="flex-shrink-0 w-[85vw] md:w-[320px] snap-center flex flex-col h-full bg-secondary/10 rounded-sm border border-border/30 p-3">
      <div className="flex items-center justify-between mb-4 px-1">
        <h3 className="font-serif text-[14px] font-bold text-foreground/80 lowercase tracking-tight">
          {group.title}
        </h3>
        <span className="text-[10px] font-mono bg-foreground/5 px-2 py-0.5 rounded-full font-bold opacity-60">
          {group.tasks.length}
        </span>
      </div>
